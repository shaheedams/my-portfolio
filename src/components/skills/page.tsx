...
const Skills = () => {
    ...
    const skillsArr: string[] = ["HTML", "CSS", "Scss", "Javascript", "Typescript", "Angular", "React", "Next.js", "Node.js", "Express.js", "RabbitMQ", "Redis", "Apis", "Mongo DB", "JQuery", "GSAP", "SWiper", "GIT", "jira", "VS CODE", "GIT hub"];
